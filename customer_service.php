...
<head>
    ...
    <title>Customer Service - James Polymer ERP</title>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-section">
                ...
                <a href="customer_service.php" class="menu-item active" data-module="customer-service">
    ...
    <div class="main-content">
        <div class="header">
            <div class="header-left">
                ...
                <h1 class="header-title">Customer Service</h1>
            </div>
        ...
        <div class="content">
            <div class="module-content active" id="customer-service">
